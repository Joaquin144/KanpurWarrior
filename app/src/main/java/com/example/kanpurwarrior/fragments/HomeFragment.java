...
public class HomeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 11","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 5","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 3","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 4","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live AXD","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Show","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
        viewAllModelList.add(new ViewAllModel(R.drawable.account_icon_image,"Live Test 1","PDF Download","Rs 599/-","Rs 2000/-"));
