 ...
 * Use the {@link MyTestsFragment#newInstance} factory method to
...
public class MyTestsFragment extends Fragment {
    ...
    public static MyTestsFragment newInstance(String param1, String param2) {
        MyTestsFragment fragment = new MyTestsFragment();
